import{_ as e}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as n,c as s,f as i}from"./app-WeARUK1X.js";const a={},l=i(`<h1 id="inspec-delta" tabindex="-1"><a class="header-anchor" href="#inspec-delta" aria-hidden="true">#</a> InSpec Delta</h1><h2 id="preparing-the-profile-before-running-delta" tabindex="-1"><a class="header-anchor" href="#preparing-the-profile-before-running-delta" aria-hidden="true">#</a> Preparing the Profile Before Running Delta</h2><p>Before running Delta, it&#39;s beneficial to format the profile to match the format Delta will use. This minimizes changes to only those necessary based on the guidance update. Follow these steps:</p><ol><li><strong>Run Cookstyle:</strong> Install the Cookstyle gem and use it to lint the controls into Cookstyle format. Verify the gem installation with <code>gem list cookstyle</code>. Create a <code>.rubocop.yml</code> file with the provided example settings or modify these settings via the command line. Run <code>cookstyle -a ./controls</code> and any tests you have for your profile.</li></ol><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>AllCops:
  Exclude:
