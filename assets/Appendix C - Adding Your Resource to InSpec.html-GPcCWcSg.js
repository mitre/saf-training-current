import{_ as r}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as l,o as t,c as o,d as n,e,b as i,f as a}from"./app-WeARUK1X.js";const c={},d=n("p",null,"Many of the official InSpec resources were written by community members. If you have created a resource for your project and would like to make it part of the official library, you can open a pull request against the InSpec codebase.",-1),u={href:"https://github.com/inspec/inspec",target:"_blank",rel:"noopener noreferrer"},p=n("code",null,"file",-1),v=n("code",null,"file_resource",-1),b=a(`<p>InSpec&#39;s source code&#39;s top level directory looks like:</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>$ tree inspec <span class="token parameter variable">-L</span> <span class="token number">1</span> <span class="token parameter variable">-d</span>
inspec
├── contrib
├── docs
├── etc
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>This is the helper file you need to adjust for the file resource:</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>$ tree <span class="token parameter variable">-L</span> <span class="token number">1</span> lib/inspec/
lib/inspec/
<span class="token punctuation">..</span>.
├── resources.rb
<span class="token punctuation">..</span>.
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Next you would need to write out your unit and integration tests:</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>$ tree test/integration/default/controls/
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>$ tree test/unit/resources/
test/unit/resources/
<span class="token punctuation">..</span>.
├── file_test.rb
<span class="token punctuation">..</span>.
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,14),m={href:"https://docs.chef.io/inspec/resources/",target:"_blank",rel:"noopener noreferrer"},h=a(`<div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>$ tree docs/resources/
docs/resources/
<span class="token punctuation">..</span>.
├── file.md.erb
<span class="token punctuation">..</span>.
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,1);function f(k,g){const s=l("ExternalLinkIcon");return t(),o("div",null,[d,n("p",null,[e("To get started, go to the main "),n("a",u,[e("InSpec Github Repo"),i(s)]),e(" and fork the repository. On your forked repository, make a new branch, and call it something unique pertaining to what resource you are making. For example, if you use the "),p,e(" resource, then a useful branch name could be "),v,e(".")]),b,n("p",null,[e("Finally, you would write up documentation on how to use the resource. This file will be published to the "),n("a",m,[e("InSpec docs"),i(s)]),e(". Take a look at the other docs pages for an idea of what needs to be documented -- each matcher and function on the resource should be listed, and examples of how to use the resource given.")]),h])}const w=r(c,[["render",f],["__file","Appendix C - Adding Your Resource to InSpec.html.vue"]]);export{w as default};
